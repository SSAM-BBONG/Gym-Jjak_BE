...
""")
    ...
    // [dashboard] 이용자 추이 — 주 단위 집계 (월요일 기준)
    @Query(value = """
            ...
            ORDER BY date
            """, nativeQuery = true)
    List<TrendPointRow> findWeeklyUserTrendByOrganizationId(@Param("organizationId") Long organizationId);

    // [dashboard] 이용자 추이 — 월 단위 집계
    @Query(value = """
            ...
            ORDER BY date
            """, nativeQuery = true)
    List<TrendPointRow> findMonthlyUserTrendByOrganizationId(@Param("organizationId") Long organizationId);

    // [dashboard] 이용자 추이 — 3개월 단위 집계 (분기 기준)
    @Query(value = """
            ...
            ORDER BY date
            """, nativeQuery = true)
    List<TrendPointRow> findThreeMonthlyUserTrendByOrganizationId(@Param("organizationId") Long organizationId);

    // [dashboard] 이용자 추이 — 6개월 단위 집계 (1월/7월 기준)
    @Query(value = """
            ...
            ORDER BY date
            """, nativeQuery = true)
    List<TrendPointRow> findSixMonthlyUserTrendByOrganizationId(@Param("organizationId") Long organizationId);
