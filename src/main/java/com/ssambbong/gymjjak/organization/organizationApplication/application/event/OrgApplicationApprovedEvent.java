...
public record OrgApplicationApprovedEvent(
        Long receiverId,
        Long organizationApplicationId,
        Instant occurredAt
) implements DomainEvent {

    public OrgApplicationApprovedEvent {
    ...
    public OrgApplicationApprovedEvent(Long receiverId, Long organizationApplicationId) {
