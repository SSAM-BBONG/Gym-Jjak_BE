...
public record AdminReportListItem(
        Long reportGroupId,
        String reportNumber, // TSID 고유 시고 번호
        ReportTargetType targetType, // 신고 대상 종류
        Long targetId, // 신고 대상 도메인 pk
        String targetDisplayText, // 신고 대상 (제목 / 댓글 일부)
        String targetOwnerUsername, // 신고 대상의 아이디
        LocalDateTime reportedAt, // 마지막 신고일
        int effectiveReportCount, // 누적된 유효 신고 수
        ReportGroupReviewStatus status, // 신고 그룹 검토 상태
