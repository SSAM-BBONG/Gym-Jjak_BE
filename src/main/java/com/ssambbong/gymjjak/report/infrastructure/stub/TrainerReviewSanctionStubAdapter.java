...
@Component
@Slf4j
public class TrainerReviewSanctionStubAdapter implements TrainerReviewSanctionPort {
    ...
    public void applySanction(
        ...
        log.warn(
                "event=trainer_review_sanction_stub_called targetId={}, action={}",
                targetId,
                action
        );

        throw new UnsupportedOperationException(
                "TrainerReviewSanctionPort 실제 구현체가 아직 연결되지 않았습니다."
        );
    }
}
