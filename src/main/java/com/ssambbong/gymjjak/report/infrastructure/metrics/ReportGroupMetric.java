...
public class ReportGroupMetric {
    ...
    // 신고 그룹 처리 완료 카운터
    private final Counter resolvedReportGroupCounter;
    ...
    public ReportGroupMetric(MeterRegistry meterRegistry,
        ...
        this.resolvedReportGroupCounter = Counter.builder("report.group.resolved")
    ...
    public void countResolvedReportGroup() {
        resolvedReportGroupCounter.increment();
    }
